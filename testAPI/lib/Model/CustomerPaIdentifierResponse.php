...
/**
 * CustomerPaIdentifierResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerPaIdentifierResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerPaIdentifierResponse';
    ...
    protected static $setters = [
        ...
        'identifier_status' => 'setIdentifierStatus',
    ...
    protected static $getters = [
        ...
        'identifier_status' => 'getIdentifierStatus',
    ...
    public const IDENTIFIER_STATUS__NEW = 'NEW';
    public const IDENTIFIER_STATUS_DELETE = 'DELETE';
    public const IDENTIFIER_STATUS_UPDATE = 'UPDATE';
    public const IDENTIFIER_STATUS_IN_PROGRESS = 'IN_PROGRESS';
    public const IDENTIFIER_STATUS_WAITINGACTIVATE = 'WAITINGACTIVATE';
    public const IDENTIFIER_STATUS_WAITINGPEPPOL = 'WAITINGPEPPOL';
    public const IDENTIFIER_STATUS_WAITINGOPTIN = 'WAITINGOPTIN';
    public const IDENTIFIER_STATUS_REFUSED = 'REFUSED';
    public const IDENTIFIER_STATUS_ERROR = 'ERROR';
    public const IDENTIFIER_STATUS_DONE = 'DONE';
    public const IDENTIFIER_STATUS_ACTIVE = 'Active';
    public const IDENTIFIER_STATUS_INACTIVE = 'Inactive';
    public const IDENTIFIER_STATUS_UPCOMING = 'Upcoming';
     ...
     * @return string[]
     */
    public function getIdentifierStatusAllowableValues()
    {
        return [
            self::IDENTIFIER_STATUS__NEW,
            self::IDENTIFIER_STATUS_DELETE,
            self::IDENTIFIER_STATUS_UPDATE,
            self::IDENTIFIER_STATUS_IN_PROGRESS,
            self::IDENTIFIER_STATUS_WAITINGACTIVATE,
            self::IDENTIFIER_STATUS_WAITINGPEPPOL,
            self::IDENTIFIER_STATUS_WAITINGOPTIN,
            self::IDENTIFIER_STATUS_REFUSED,
            self::IDENTIFIER_STATUS_ERROR,
            self::IDENTIFIER_STATUS_DONE,
            self::IDENTIFIER_STATUS_ACTIVE,
            self::IDENTIFIER_STATUS_INACTIVE,
            self::IDENTIFIER_STATUS_UPCOMING,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('identifier_status', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getIdentifierStatusAllowableValues();
        if (!is_null($this->container['identifier_status']) && !in_array($this->container['identifier_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'identifier_status', must be one of '%s'",
                $this->container['identifier_status'],
    ...
    /**
     * Gets identifier_status
     *
     * @return string|null
     */
    public function getIdentifierStatus()
    {
        return $this->container['identifier_status'];
    }

    /**
     * Sets identifier_status
     *
     * @param string|null $identifier_status identifier_status
     *
     * @return self
     */
    public function setIdentifierStatus($identifier_status)
    {
        if (is_null($identifier_status)) {
            throw new \InvalidArgumentException('non-nullable identifier_status cannot be null');
        }
        $allowedValues = $this->getIdentifierStatusAllowableValues();
        if (!in_array($identifier_status, $allowedValues, true)) {
        ...
        $this->container['identifier_status'] = $identifier_status;
