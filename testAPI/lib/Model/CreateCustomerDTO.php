 ...
 *
 * @category Class
 * @description Payload containing information to create a new customer.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CreateCustomerDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const API_USER_Y = 'Y';
    public const API_USER_N = 'N';
     ...
     * @return string[]
     */
    public function getApiUserAllowableValues()
    {
        return [
            self::API_USER_Y,
            self::API_USER_N,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('language', $data ?? [], 'fr_FR');
        $this->setIfExists('logo', $data ?? [], null);
        $this->setIfExists('activation_pa', $data ?? [], 'Y');
        $this->setIfExists('reception_pa', $data ?? [], 'Y');
        $this->setIfExists('api_user', $data ?? [], 'Y');
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['customer_name']) < 0)) {
            $invalidProperties[] = "invalid value for 'customer_name', the character length must be bigger than or equal to 0.";
        }

        if ($this->container['customer_legal_id'] === null) {
            $invalidProperties[] = "'customer_legal_id' can't be null";
        }
        if (!is_null($this->container['customer_vat']) && (mb_strlen($this->container['customer_vat']) > 255)) {
            $invalidProperties[] = "invalid value for 'customer_vat', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['customer_vat']) && (mb_strlen($this->container['customer_vat']) < 0)) {
            $invalidProperties[] = "invalid value for 'customer_vat', the character length must be bigger than or equal to 0.";
        }
        ...
        $allowedValues = $this->getApiUserAllowableValues();
        if (!is_null($this->container['api_user']) && !in_array($this->container['api_user'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'api_user', must be one of '%s'",
                $this->container['api_user'],
                implode("', '", $allowedValues)
            );
        }

        if (!is_null($this->container['start_date']) && !preg_match("/^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-([0-9]{4})$/", $this->container['start_date'])) {
    ...
    public function setCustomerName($customer_name)
    {
        ...
        if ((mb_strlen($customer_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customer_name when calling CreateCustomerDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($customer_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $customer_name when calling CreateCustomerDTO., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $customer_legal_id customer_legal_id
     *
     * @return self
     */
    ...
    public function setCustomerVat($customer_vat)
    {
        ...
        if ((mb_strlen($customer_vat) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customer_vat when calling CreateCustomerDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($customer_vat) < 0)) {
            throw new \InvalidArgumentException('invalid length for $customer_vat when calling CreateCustomerDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setAddressLine1($address_line1)
    {
        ...
        if ((mb_strlen($address_line1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling CreateCustomerDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($address_line1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling CreateCustomerDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setAddressLine2($address_line2)
    {
        ...
        if ((mb_strlen($address_line2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling CreateCustomerDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($address_line2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling CreateCustomerDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setAddressLine3($address_line3)
    {
        ...
        if ((mb_strlen($address_line3) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling CreateCustomerDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($address_line3) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling CreateCustomerDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling CreateCustomerDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling CreateCustomerDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $city when calling CreateCustomerDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling CreateCustomerDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country)))) {
            throw new \InvalidArgumentException("invalid value for \$country when calling CreateCustomerDTO., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((!preg_match("/^[a-z]{2}_[A-Z]{2}$/", ObjectSerializer::toString($language)))) {
            throw new \InvalidArgumentException("invalid value for \$language when calling CreateCustomerDTO., must conform to the pattern /^[a-z]{2}_[A-Z]{2}$/.");
        }
     ...
     * Sets activation_pa
     *
     * @param string|null $activation_pa activation PA flag (Y/N)
     *
     * @return self
     */
     ...
     * Sets reception_pa
     *
     * @param string|null $reception_pa Reception PA flag (Y/N)
     *
     * @return self
     */
     ...
     * Sets api_user
     *
     * @param string|null $api_user Api user flag (Y/N)
     *
     * @return self
     */
    ...
    {
        if (is_null($api_user)) {
            throw new \InvalidArgumentException('non-nullable api_user cannot be null');
        }
        $allowedValues = $this->getApiUserAllowableValues();
        if (!in_array($api_user, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'api_user', must be one of '%s'",
                    $api_user,
     ...
     * Sets start_date
     *
     * @param string|null $start_date Start date in DD-MM-YYYY format (minimum 10 days in the future). Required when electronicAddresses is provided
     *
     * @return self
     */
    public function setStartDate($start_date)
    {
        ...
        if ((!preg_match("/^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-([0-9]{4})$/", ObjectSerializer::toString($start_date)))) {
            throw new \InvalidArgumentException("invalid value for \$start_date when calling CreateCustomerDTO., must conform to the pattern /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-([0-9]{4})$/.");
        }
