<?php
/**
 * CustomerIdentifiersPageResponseDTO
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CustomerIdentifiersPageResponseDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerIdentifiersPageResponseDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerIdentifiersPageResponseDTO';
    ...
    protected static $openAPITypes = [
        ...
        'offset' => 'int',
        'total' => 'int',
        'identifiers' => '\OpenAPI\Client\Model\CustomerPaIdentifierResponse[]'
    ];
    ...
    */
     ...
     * Gets identifiers
     *
     * @return \OpenAPI\Client\Model\CustomerPaIdentifierResponse[]|null
     */
     ...
     * Sets identifiers
     *
     * @param \OpenAPI\Client\Model\CustomerPaIdentifierResponse[]|null $identifiers identifiers
     *
     * @return self
     */
