...
/**
 * EDIUserCreationResponseDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EDIUserCreationResponseDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EDIUserCreationResponseDTO';
    ...
    */
     ...
     * Sets client_id
     *
     * @param string|null $client_id Generated client ID (UUID) for the EDI user
     *
     * @return self
     */
     ...
     * Sets client_secret
     *
     * @param string|null $client_secret Client secret associated with the clientId for the EDI user
     *
     * @return self
     */
