...
/**
 * ElectronicAddressDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ElectronicAddressDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ElectronicAddressDTO';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['electronic_address'] === null) {
    ...
    public function setElectronicAddress($electronic_address)
    {
        if (is_null($electronic_address)) {
            throw new \InvalidArgumentException('non-nullable electronic_address cannot be null');
        }
