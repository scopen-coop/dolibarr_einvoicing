<?php
/**
 * UpdateCustomerPaIdentifierRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UpdateCustomerPaIdentifierRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateCustomerPaIdentifierRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateCustomerPaIdentifierRequest';
    ...
    */
     ...
     * Sets start_date
     *
     * @param string|null $start_date Start date in DD-MM-YYYY format, min 10 days in the future
     *
     * @return self
     */
    public function setStartDate($start_date)
    {
        ...
        if ((!preg_match("/^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-([0-9]{4})$/", ObjectSerializer::toString($start_date)))) {
            throw new \InvalidArgumentException("invalid value for \$start_date when calling UpdateCustomerPaIdentifierRequest., must conform to the pattern /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-([0-9]{4})$/.");
        }
    ...
    public function setEndDate($end_date)
    {
        ...
        if ((!preg_match("/^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-([0-9]{4})$/", ObjectSerializer::toString($end_date)))) {
            throw new \InvalidArgumentException("invalid value for \$end_date when calling UpdateCustomerPaIdentifierRequest., must conform to the pattern /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-([0-9]{4})$/.");
        }
