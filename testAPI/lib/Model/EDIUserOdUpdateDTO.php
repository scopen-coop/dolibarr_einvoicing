...
/**
 * EDIUserOdUpdateDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EDIUserOdUpdateDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EDIUserOdUpdateDTO';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[a-z]{2}_[A-Z]{2}$/", $this->container['language'])) {
    ...
    public function setLanguage($language)
    {
        ...
        if ((!preg_match("/^[a-z]{2}_[A-Z]{2}$/", ObjectSerializer::toString($language)))) {
            throw new \InvalidArgumentException("invalid value for \$language when calling EDIUserOdUpdateDTO., must conform to the pattern /^[a-z]{2}_[A-Z]{2}$/.");
        }
