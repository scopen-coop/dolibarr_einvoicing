...
/**
 * SupervisorApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class SupervisorApi
{
     ...
     *
     * @param  string $request_id Header parameter used to correlate logs from several components (optional)
     ...
     * @return void
     */
    public function getHealth($request_id = null, string $contentType = self::contentTypes['getHealth'][0])
    {
        $this->getHealthWithHttpInfo($request_id, $contentType);
    }
     ...
     */
    public function getHealthWithHttpInfo($request_id = null, string $contentType = self::contentTypes['getHealth'][0])
    {
        $request = $this->getHealthRequest($request_id, $contentType);
     ...
     */
    public function getHealthAsync($request_id = null, string $contentType = self::contentTypes['getHealth'][0])
    {
        return $this->getHealthAsyncWithHttpInfo($request_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getHealthAsyncWithHttpInfo($request_id = null, string $contentType = self::contentTypes['getHealth'][0])
    {
        $returnType = '';
        $request = $this->getHealthRequest($request_id, $contentType);
     ...
     */
    public function getHealthRequest($request_id = null, string $contentType = self::contentTypes['getHealth'][0])
    {
        ...
        // header params
        if ($request_id !== null) {
            $headerParams['Request-Id'] = ObjectSerializer::toHeaderValue($request_id);
        }
