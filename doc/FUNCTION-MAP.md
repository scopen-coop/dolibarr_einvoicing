...
*module 1.2.0, commit 05ffc589, generated 2026-09-07. Clickable version: [function-map.html](function-map.html).*
...
```
  ...
  |   @ core/triggers/interface_98_modEInvoicing_EInvoicingTriggers.class.php:172         |
  +---------------------------------------------------------------------------------------+
                |
  ...
  |   @ class/protocols/CIIProtocol.class.php:544                                         |
  +---------------------------------------------------------------------------------------+
                |
                v
  +---------------------------------------------------------------------------------------+
  | generateXML()                                                                         |
  |   @ class/protocols/CIIProtocol.class.php:338                                         |
  +---------------------------------------------------------------------------------------+
                |
                v
  +---------------------------------------------------------------------------------------+
  ...
  |   @ class/protocols/CIIProtocol.class.php:2065                                        |
  +---------------------------------------------------------------------------------------+
                |
                v
  +---------------------------------------------------------------------------------------+
  ...
  |   @ class/protocols/AbstractProtocol.class.php:203                                    |
  +---------------------------------------------------------------------------------------+
                |
                v
  +---------------------------------------------------------------------------------------+
  ...
  |       @ class/protocols/FacturXProtocol.class.php:81                                  |
  +---------------------------------------------------------------------------------------+
                |
                v
  +---------------------------------------------------------------------------------------+
  ...
  |       @ class/providers/EsalinkPDPProvider.class.php:412                              |
  +---------------------------------------------------------------------------------------+
                |
                v
  +---------------------------------------------------------------------------------------+
  ...
  |       GET flows/{id}?docType=Metadata                                                 |
  |       extlink AWAITING_VALIDATION, then the ack                                       |
  |       @ class/providers/EsalinkPDPProvider.class.php:431                              |
  +---------------------------------------------------------------------------------------+
```
...
```
  ...
  |       @ core/triggers/interface_98_modEInvoicing_EInvoicingTriggers.class.php:277 |
  |                                                                                   |
  ...
  |       @ core/triggers/interface_98_modEInvoicing_EInvoicingTriggers.class.php:302 |
  |                                                                                   |
  ...
  |       @ class/providers/SuperPDPProvider.class.php:2975                           |
  |                                                                                   |
  |   * Esalink (Hubtimize)                                                           |
  |       is the code sendable for that object ?                                      |
  |       CdarHandler::generateCdarFile()                                             |
  |       POST flows, flowSyntax CDAR                                                 |
  |       storeStatusMessage(), then the verdict                                      |
  |       @ class/providers/EsalinkPDPProvider.class.php:1798                         |
  +-----------------------------------------------------------------------------------+
                |
                v
  +-----------------------------------------------------------------------------------+
  ...
  |   @ class/einvoicing.class.php:3335                                               |
  +-----------------------------------------------------------------------------------+
                |
  ...
  |   @ class/einvoicing.class.php:3496                                               |
  +-----------------------------------------------------------------------------------+
                |
                v
  +-----------------------------------------------------------------------------------+
  ...
  |   @ class/utils/SupplierInvoiceHelper.class.php:639                               |
  +-----------------------------------------------------------------------------------+
```
...
```
  ...
  |       @ class/providers/SuperPDPProvider.class.php:1782                                |
  |                                                                                        |
  |   * Esalink (Hubtimize)                                                                |
  |       hubtimize.fr/api/orchestrator/v1/                                                |
  ...
  |       discards the flows already stored                                                |
  |       @ class/providers/EsalinkPDPProvider.class.php:856                               |
  +----------------------------------------------------------------------------------------+
                |
                v
  +----------------------------------------------------------------------------------------+
  ...
  |       @ class/providers/SuperPDPProvider.class.php:2209                                |
  |                                                                                        |
  |   * Esalink (Hubtimize)                                                                |
  |       hubtimize.fr/api/orchestrator/v1/                                                |
  |       GET flows/{id}?docType=Metadata                                                  |
  ...
  |       syntax, profile, ack_*, submittedAt                                              |
  |       then the switch below                                                            |
  |       @ class/providers/EsalinkPDPProvider.class.php:1223                              |
  +----------------------------------------------------------------------------------------+
                |
                v
  +----------------------------------------------------------------------------------------+
  ...
  |       @ class/providers/AbstractPDPProvider.class.php:460                              |
  |                                                                                        |
  |   * "CustomerInvoiceLC"                                                                |
  ...
  |          updateStatusMessageValidation()                                               |
  |       @ class/providers/SuperPDPProvider.class.php:2812                                |
  |                                                                                        |
  |   * "" (empty)                                                                         |
...
```
  ...
  |   @ class/protocols/CIIProtocol.class.php:677                                                    |
  +--------------------------------------------------------------------------------------------------+
                |
                v
  +--------------------------------------------------------------------------------------------------+
  | doCreateSupplierInvoiceFromSource()                                                              |
  |   @ class/protocols/CIIProtocol.class.php:793                                                    |
  +--------------------------------------------------------------------------------------------------+
                |
                v
  +--------------------------------------------------------------------------------------------------+
  ...
  |   @ class/protocols/CIIProtocol.class.php:1739                                                   |
  +--------------------------------------------------------------------------------------------------+
                |
                v
  +--------------------------------------------------------------------------------------------------+
  ...
  |   @ class/protocols/CommonProtocol.class.php:456                                                 |
  +--------------------------------------------------------------------------------------------------+
                |
                v
  ...
  |     else a free line                                                                             |
  |   @ class/protocols/CIIProtocol.class.php:1236                                                   |
  +--------------------------------------------------------------------------------------------------+
                |
                v
  +--------------------------------------------------------------------------------------------------+
  ...
  |   @ class/protocols/CIIProtocol.class.php:726                                                    |
  +--------------------------------------------------------------------------------------------------+
                |
                v
  +--------------------------------------------------------------------------------------------------+
  ...
  |   core update_price()                                                                            |
  |   @ class/protocols/CIIProtocol.class.php:3463                                                   |
  +--------------------------------------------------------------------------------------------------+
```
